    ...
    experience: {
      ...
      entries: {
        mentatech: {
          ...
          bullets: [
            {
              text: 'Led architecture of Next.js (TypeScript) frontend, achieving ~35% reduction in page load time through strategic code-splitting and dynamic imports.',
              metric: '35%',
            },
            {
              text: 'Integrated Datadog observability stack, reducing mean time to detection (MTTD) of production incidents by 80%.',
              metric: '80%',
            },
            {
              text: 'Redesigned CI/CD pipelines with GitHub Actions, cutting deployment time by 80% across frontend and backend services.',
              metric: '80%',
            },
            {
        ...
        cor: {
          ...
          bullets: [
            {
              text: 'Built and maintained React features for a SaaS project management platform adopted by 100+ professionals across distributed teams.',
              metric: '100+',
            },
            {
    ...
    experience: {
      ...
      entries: {
        mentatech: {
          ...
          bullets: [
            {
              text: 'Lideré la arquitectura del frontend en Next.js (TypeScript), logrando una reducción de ~35% en el tiempo de carga mediante code-splitting estratégico e imports dinámicos.',
              metric: '35%',
            },
            {
              text: 'Integré el stack de observabilidad de Datadog, reduciendo el tiempo medio de detección (MTTD) de incidentes en producción en un 80%.',
              metric: '80%',
            },
            {
              text: 'Rediseñé los pipelines de CI/CD con GitHub Actions, reduciendo el tiempo de deploy en un 80% en servicios frontend y backend.',
              metric: '80%',
            },
            {
        ...
        cor: {
          ...
          bullets: [
            {
              text: 'Desarrollé y mantuve funcionalidades React para una plataforma SaaS de gestión de proyectos adoptada por más de 100+ profesionales en equipos distribuidos.',
              metric: '100+',
            },
            {
